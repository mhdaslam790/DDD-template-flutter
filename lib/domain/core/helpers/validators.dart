...
class Validators {
  ...
  static final emailRegex = RegExp(r"^\S+@[a-zA-Z0-9-]+\.[a-zA-Z]+");
  ...
  static String? expense(String? value, BuildContext context) {
    value = value!.trim();
    if (value.isEmpty) {
  ...
  static String? money(String? value, BuildContext context) {
    value = value!.trim();
    if (value.isEmpty) {
      return AppLocalizations.of(context).pleaseEnterAnAmount;
  ...
  static String? decimal(String? value, BuildContext context) {
    value = value!.trim();
    if (value.isEmpty) {
      return AppLocalizations.of(context).thisFieldIsRequired;
    }
  ...
  static String? taxRate(String? value, BuildContext context) {
    value = value!.trim();
    if (value.isEmpty) {
      return AppLocalizations.of(context).thisFieldIsRequired;
    }
